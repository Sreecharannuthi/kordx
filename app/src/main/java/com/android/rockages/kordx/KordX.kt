...
class KordX(application: Application) : AndroidViewModel(application), KordX.Hooks {
 ...
 companion object {
 /**
 * Static reference to the live [KordX] instance, set in [init] and cleared
 * in [onCleared]. Used by [com.android.rockages.kordx.services.radio.KordXMediaLibraryService]
