...
class RadioNotificationManager(val kordx: KordX) {
 private var manager = NotificationManagerCompat.from(kordx.applicationContext)
 ...
 setName(kordx.applicationContext.getString(R.string.app_name))
 ...
 val intent = Intent(kordx.applicationContext, RadioNotificationService::class.java)
 kordx.applicationContext.startForegroundService(intent)
