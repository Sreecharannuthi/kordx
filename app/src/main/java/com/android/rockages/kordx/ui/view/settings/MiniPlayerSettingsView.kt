...
fun MiniPlayerSettingsView(context: ViewContext) {
 ...
 val miniPlayerTrackControls by context.kordx.settings.miniPlayerTrackControls.flow.collectAsState()
 val miniPlayerSeekControls by context.kordx.settings.miniPlayerSeekControls.flow.collectAsState()
 val miniPlayerTextMarquee by context.kordx.settings.miniPlayerTextMarquee.flow.collectAsState()
 ...
 Text("${context.kordx.t.Settings} - ${context.kordx.t.MiniPlayer}")
 }
 },
 ...
 SettingsSideHeading(context.kordx.t.MiniPlayer)
 SettingsSwitchTile(
 icon = {
 Icon(Icons.Filled.SkipNext, null)
 },
 title = {
 Text(context.kordx.t.ShowTrackControls)
 },
 value = miniPlayerTrackControls,
 onChange = { value ->
 context.kordx.settings.miniPlayerTrackControls.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSwitchTile(
 ...
 onChange = { value ->
 context.kordx.settings.miniPlayerSeekControls.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSwitchTile(
 ...
 title = {
 Text(context.kordx.t.MiniPlayerTextMarquee)
 },
 value = miniPlayerTextMarquee,
 onChange = { value ->
 context.kordx.settings.miniPlayerTextMarquee.setValue(value)
 }
 )
 }
 }
