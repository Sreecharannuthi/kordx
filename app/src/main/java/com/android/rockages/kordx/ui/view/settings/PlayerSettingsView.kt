...
fun PlayerSettingsView(context: ViewContext) {
 ...
 val fadePlayback by context.kordx.settings.fadePlayback.flow.collectAsState()
 ...
 Text("${context.kordx.t.Settings} - ${context.kordx.t.Player}")
 }
 },
 ...
 SettingsSideHeading(context.kordx.t.Player)
 SettingsSwitchTile(
 icon = {
 Icon(Icons.Filled.GraphicEq, null)
 },
 title = {
 Text(context.kordx.t.FadePlaybackInOut)
 },
 value = fadePlayback,
 onChange = { value ->
 context.kordx.settings.fadePlayback.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSliderTile(
 ...
 onChange = { value ->
 context.kordx.settings.fadePlaybackDuration.setValue(value)
 },
 onReset = {
 context.kordx.settings.fadePlaybackDuration.setValue(
 context.kordx.settings.fadePlaybackDuration.defaultValue,
 )
 },
 )
 HorizontalDivider()
 ...
 title = {
 Text(context.kordx.t.RequireAudioFocus)
 },
 value = requireAudioFocus,
 onChange = { value ->
 context.kordx.settings.requireAudioFocus.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSwitchTile(
 ...
 title = {
 Text(context.kordx.t.IgnoreAudioFocusLoss)
 },
 ...
 title = {
 Text(context.kordx.t.PlayOnHeadphonesConnect)
 },
 value = playOnHeadphonesConnect,
 onChange = { value ->
 context.kordx.settings.playOnHeadphonesConnect.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSwitchTile(
 ...
 title = {
 Text(context.kordx.t.PauseOnHeadphonesDisconnect)
 },
 value = pauseOnHeadphonesDisconnect,
 onChange = { value ->
 context.kordx.settings.pauseOnHeadphonesDisconnect.setValue(value)
 }
 )
 HorizontalDivider()
 SettingsSliderTile(
 ...
 title = {
 Text(context.kordx.t.FastRewindDuration)
 },
 label = { value ->
 Text(context.kordx.t.XSecs(value.toString()))
 },
 ...
 onChange = { value ->
 context.kordx.settings.seekBackDuration.setValue(value.toInt())
 },
 onReset = {
 context.kordx.settings.seekBackDuration.setValue(
 context.kordx.settings.seekBackDuration.defaultValue,
 )
 },
 )
 HorizontalDivider()
 ...
 title = {
 Text(context.kordx.t.FastForwardDuration)
 },
 label = { value ->
 Text(context.kordx.t.XSecs(value.toString()))
 },
 ...
 onChange = { value ->
 context.kordx.settings.seekForwardDuration.setValue(value.toInt())
 },
 onReset = {
 context.kordx.settings.seekForwardDuration.setValue(
 context.kordx.settings.seekForwardDuration.defaultValue,
 )
 },
 )
 HorizontalDivider()
